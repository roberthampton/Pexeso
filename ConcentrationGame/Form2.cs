...
namespace ConcentrationGame
{
    public partial class Concentration : Form
    {
        ...
        private void gameOver()
        {
            ...
            {
               // DialogResult player1Winner = MessageBox.Show(, MessageBoxButtons.YesNo);
        ...
        public void Reset()
        {
            Concentration newGame = new Concentration(btn.GetLength(0), btn.GetLength(1));
            newGame.Show();
        }
